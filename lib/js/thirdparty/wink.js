// This modually is neither officially-endorsed or supported by Wink
...
var on_text = function(data, property) {
    ...
    text =  { buttons         : ''
            ...
            , hubs            : 'OK'
            , linked_services : 'OK'
            , light_bulbs     : (data.brightness == 1.0  ? ''     : (data.brightness * 100) + '%')
            , locks           : 'LOCKED'
    ...
    if (text === '') text = (data[property + '_true'] === 'N/A') ? 'UNKNOWN' : 'OK'
...
var style_element = function(data, property) {
    ...
    if ((color == blue) && (data[property + '_true'] === 'N/A')) color = yellow
